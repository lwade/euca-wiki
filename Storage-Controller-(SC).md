## DesignDoc for the Cloud Admin for Eucalyptus 3.1, see notes for 3.2 features in progress)
...
**DAS Storage (direct attached as block device), coming in Eucalyptus 3.2**
