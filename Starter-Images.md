...
<table>
    ...
    <tr>
       ...
       <td>This image does not have SELinux / iptables enables. It has got a root disk of 4.5G. You should be using root to login. It works w/ kexec kernel ( default kernel is provided as part of tar ).</td>
    </tr>
    <tr>
       <td></td>
       <td></td>
